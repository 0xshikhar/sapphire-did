...
exports.datasetRouter = (0, express_1.Router)();
const datasetService = new dataset_service_1.DatasetService();
 ...
 */
exports.datasetRouter.get('/my-datasets', user_controller_1.authenticateUser, async (req, res) => {
    var _a;
    try {
        const userDid = (_a = req.user) === null || _a === void 0 ? void 0 : _a.did;
        if (!userDid) {
 ...
 * POST /datasets
 */
exports.datasetRouter.post('/', user_controller_1.authenticateUser, upload.single('file'), async (req, res) => {
    var _a;
    try {
        ...
        await gdprService.recordDataAccess(userId, 'dataset', dataset.id, 'create', req.ip, req.headers['user-agent']);
 ...
 * GET /datasets
 */
exports.datasetRouter.get('/', user_controller_1.authenticateUser, async (req, res) => {
    var _a;
    try {
        const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
 ...
 * GET /datasets/search
 */
exports.datasetRouter.get('/search', async (req, res) => {
    var _a;
    try {
 ...
 * GET /datasets/:id
 */
exports.datasetRouter.get('/:id', async (req, res) => {
    try {
        ...
        if (req.user) {
            await gdprService.recordDataAccess(req.user.id, 'dataset', dataset.id, 'read', req.ip, req.headers['user-agent']);
        }
 ...
 */
exports.datasetRouter.get('/did/:did', async (req, res) => {
    try {
 ...
 * PATCH /datasets/:id
 */
exports.datasetRouter.patch('/:id', user_controller_1.authenticateUser, async (req, res) => {
    var _a;
    try {
        const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
        const datasetId = req.params.id;
        ...
        // Update the dataset
        const updatedDataset = await datasetService.updateDataset(datasetId, userId, updates);
        // Record the update
        await gdprService.recordDataAccess(userId, 'dataset', datasetId, 'update', req.ip, req.headers['user-agent']);
 ...
 * DELETE /datasets/:id
 */
exports.datasetRouter.delete('/:id', user_controller_1.authenticateUser, async (req, res) => {
    var _a;
    try {
        const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
        const datasetId = req.params.id;
        ...
        // Record the deletion
        await gdprService.recordDataAccess(userId, 'dataset', datasetId, 'delete', req.ip, req.headers['user-agent']);
 ...
 */
exports.datasetRouter.get('/:id/suggest-categories', user_controller_1.authenticateUser, async (req, res) => {
    var _a;
    try {
        const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
        const datasetId = req.params.id;
        ...
        // Get suggestions
        const categories = await aiService.suggestCulturalCategories(dataset.aiTags, dataset.metadata);
        res.status(200).json({
 ...
 */
exports.datasetRouter.get('/:id/access-history', user_controller_1.authenticateUser, async (req, res) => {
    var _a;
    try {
        const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
        const datasetId = req.params.id;
